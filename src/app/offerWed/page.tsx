...
const OfferWedding = () => {
    ...
    // event data
    const eventTitle = "VENČANJA";
    const eventNames = ["venčanje", "venčanja"];
    const eventPrice = "2000 €";
    const eventType = "v";
    const eventPhoto = "/wd.jpg"
    const eventDescription = `Vaš poseban dan zaslužuje pažnju do najsitnijeg detalja. Agencija
        „Trenuci za pamćenje“ kreira venčanja koja odišu elegancijom i stilom,
        prilagođena vašim željama. Od dekoracije i muzike do savršenog
        ambijenta, stvorićemo trenutke koji se pamte zauvek.`
