...
const OfferBirthday = () => {
    ...
    const eventTitle = "ROĐENDANI";
    const eventNames = ["rođendan", "rođendana"];
    const eventPrice = "500 €";
    const eventType = "r";
    const eventPhoto = "/bd.jpg"
    const eventDescription = `Proslava rođendana je savršen trenutak za okupljanje porodice i
                        prijatelja u opuštenoj i radosnoj atmosferi. Naša agencija „Trenuci za
                        pamćenje“ nudi sve što vam je potrebno za nezaboravan događaj:
                        dekoraciju, muziku, kreativne igre za decu i raznovrstan meni
                        prilagođen vašim željama. Bez obzira na to da li organizujete mali
                        porodični ručak ili veliku zabavu, tu smo da svaki detalj učinimo
                        posebnim i stvorimo uspomene koje ćete pamtiti zauvek.`
