...
const OfferGraduation = () => {
    ...
    // event data
    const eventTitle = "MATURE";
    const eventNames = ["maturu", "mature"];
    const eventPrice = "600 €";
    const eventType = "m";
    const eventPhoto = "/mmm.jpeg"
    const eventDescription = `Proslava mature je poseban trenutak koji zaslužuje savršen događaj.
        Agencija „Trenuci za pamćenje“ nudi vrhunsku organizaciju i kreativne
        ideje za dekoraciju, muziku i atmosferu koja odražava vašu energiju i
        uspeh. Stvorimo zajedno uspomene za ceo život!`
...
export default OfferGraduation;