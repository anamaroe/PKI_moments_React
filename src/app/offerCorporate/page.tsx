...
const OfferCorporate = () => {

    // event data
    const eventTitle = "KORPORATIVNI DOGAĐAJI";
    const eventNames = ["korporativni događaj", "korporativnog događaja"];
    const eventPrice = "200 €";
    const eventType = "k";
    const eventPhoto = "/sed.jpg"
    const eventDescription = `Bilo da planirate konferenciju, seminar, team building ili svečanu
        proslavu, agencija „Trenuci za pamćenje“ pruža kompletnu organizaciju
        korporativnih događaja. Naš cilj je da stvorimo događaje koji inspirišu,
        povezuju i ostavljaju snažan utisak na vaše saradnike i klijente.`
